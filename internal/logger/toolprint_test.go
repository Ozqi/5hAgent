...
func TestPrintToolErrorSendsShortSummaryToSink(t *testing.T) {
	...
	PrintToolError("base.edit", `{}`, errors.New("[EnhancedLocalFunc] failed to invoke tool, toolName=base.edit, err=failed to read file '/home/lzq/Proj/5hAgent/testspace/tool_test.txt': open /home/lzq/Proj/5hAgent/testspace/tool_test.txt: no such file or directory. Make sure the path is correct and the file exists. Use absolute paths like '/home/user/project/file.py'"))
